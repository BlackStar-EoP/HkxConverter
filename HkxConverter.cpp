...
int main(int argc, char** argv) {
    ...
    const char* inputFile = "D:/trash panic/Stage1_Ref_Model.dmp/Humberger/HUMBURGER.hkx";
    const char* outputFile = "D:/trash panic/Stage1_Ref_Model.dmp/Humberger/HUMBURGER.danny.hkx";
    ...
    FILE* dest = NULL;
    if (argc > 2) dest = fopen(outputFile, "wb");
    else dest = fopen((ToString(inputFile) + ".out").c_str(), "wb");
